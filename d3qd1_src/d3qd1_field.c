...
int mEMP_s(double complex *U,double *rt,int type,DQD1 *qd)
{
  ...
  if(qd->bd.ps==1){
    l=q0_domain_id_l(rt,qd);
    r0[0]=rt[0]-(double)l*qd->bd.qd.d;
    r0[1]=rt[1];
    r0[2]=rt[2];
    did=domain_id(r0,qd);
  }
  ...
  if(l!=0){
    arg=(double)l*qd->bd.qd.kx*qd->bd.qd.d;
...
int mEMP_t(double complex *U,double *rt,int type,DQD1 *qd)
{
...
int mEMP_i(double complex *U,double *rt,int type,DQD1 *qd)
{
  double complex e[3],h[3];
  int did,i;
...
int EH_mEMP_s(double complex *E,double complex *H,double *rt,int type,DQD1 *qd)
{
  double complex CC[9],dC[3][9],kc,ch,ce,U[4],dU[3][4];
  double F,i_C,dF[3],r0[3],arg;
  int did,l,i,s,sd,p,n,d;
...
int EH_mEMP_t(double complex *E,double complex *H,double *rt,int type,DQD1 *qd)
{
  double complex e[3],h[3];
  int did,i;
...
int EH_mEMP_i(double complex *E,double complex *H,double *rt,int type,DQD1 *qd)
{
  int did;
