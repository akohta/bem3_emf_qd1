...
{
  void bil_force_4p(double *F,double *N,double *rc,int s,DQD1 *qd);
  void bil_force_9p(double *F,double *N,double *rc,int s,DQD1 *qd);
  void lit_force_4p(double *F,double *N,double *rc,int s,DQD1 *qd);
  void lit_force_7p(double *F,double *N,double *rc,int s,DQD1 *qd);
...
void bil_force_9p(double *F,double *N,double *rc,int s,DQD1 *qd)
{
  ...
  for(i=0;i<9;i++){
    ...
    EH_t_bd(e,h,0,s,qd->bd.zt_49[i],qd->bd.et_49[i],PREC_DEF_FN,qd); 
